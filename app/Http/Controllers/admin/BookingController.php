...
public function index(Request $request)
{
    ...
    $booking = DB::table('booking')
            ...
            ->join('deposit', 'booking.bookingID', '=', 'deposit.bookingID')
            ...
            ->select('booking.*', 'timess.duration', 'formatss.formatname', 'deposit.imagedeposit', 'deposit.price', 'deposit.comment')
    ...
    {   
       ...
       ->join('deposit', 'booking.bookingID', '=', 'deposit.bookingID')
        ...
        ->select('booking.*', 'deposit.imagedeposit', 'timess.duration', 'formatss.formatname', 'deposit.price', 'deposit.comment')      
        ->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        ->where('deposit.bookingID', $id)->limit(1);
        $deposit->update(['comment' => $requestData['comment']]);
